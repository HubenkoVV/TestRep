...
public class Controller {
    ...
    private void chooseInterval(Scanner sc){
        while (true) {
            ...
            if (agree.equalsIgnoreCase(YES) ||agree.equalsIgnoreCase(YES_UA)) {
                makeUserInterval(sc);
                break;
            } else if (agree.equalsIgnoreCase(NO)||agree.equalsIgnoreCase(NO_UA)) {
